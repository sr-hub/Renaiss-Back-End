...
RSpec.describe SkillsController, type: :controller do
  ...
  describe "POST #create" do
    context "with valid params" do
      ...
      it "renders a JSON response with the new skill" do

        post :create, params: {skill: valid_attributes}, session: valid_session
        expect(response).to have_http_status(:created)
        expect(response.content_type).to eq('application/json')
        expect(response.location).to eq(skill_url(Skill.last))
      end
    end

    context "with invalid params" do
      it "renders a JSON response with errors for the new skill" do
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "renders a JSON response with the skill" do
        skill = Skill.create! valid_attributes
    ...
    context "with invalid params" do
      it "renders a JSON response with errors for the skill" do
        skill = Skill.create! valid_attributes
